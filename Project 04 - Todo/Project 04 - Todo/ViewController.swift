...
extension ViewController: UITableViewDataSource {
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        if todos.count != 0 {
            ...
            setMessageLabel(messageLabel, frame: CGRect(x: 0, y: 0, width: view.bounds.size.width, height: view.bounds.size.height), text: "No Data is currently available.", textColor: UIColor.black, numberOfLines: 0, textAlignment: NSTextAlignment.center, font: UIFont(name: "Palatino-Italic", size: 20)! )
